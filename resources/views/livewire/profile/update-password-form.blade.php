        ...
        <div>
            ...
            <div class="relative mt-1">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="h-5 w-5 text-gray-400"
                        fill="currentColor">
                        <path fill-rule="evenodd"
                ...
                <x-text-input wire:model="current_password" id="update_password_current_password"
                    name="current_password" type="password" class="mt-1 block w-full pl-10"
        ...
        <div>
            ...
            <div class="relative mt-1">
                ...
                <x-text-input wire:model="password" id="update_password_password" name="password" type="password"
                    class="mt-1 block w-full pl-10" autocomplete="new-password" />
            </div>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">The password must be at least 8 characters
            </p>
        ...
        <div>
            ...
            <div class="relative mt-1">
                ...
                <x-text-input wire:model="password_confirmation" id="update_password_password_confirmation"
                    name="password_confirmation" type="password" class="mt-1 block w-full pl-10"
